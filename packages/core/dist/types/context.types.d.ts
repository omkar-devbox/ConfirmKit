 ...
 */
export type ContextUpdater<C extends ConfirmContext = ConfirmContext> = Partial<C> | ((prev: Readonly<C>) => Partial<C>);
/**
 * Async context updater for API-based changes.
 */
export type AsyncContextUpdater<C extends ConfirmContext = ConfirmContext> = ContextUpdater<C> | ((prev: Readonly<C>) => Promise<Partial<C>>);
/**
