...
export type Position = 'center' | 'top' | 'bottom' | 'left' | 'right' | 'fullscreen' | string;
export type Size = 'sm' | 'md' | 'lg' | 'xl' | number | string;
/** Action triggered by key press */
export type KeyAction = 'confirm' | 'cancel' | 'close' | 'next' | 'prev' | 'back' | string;
