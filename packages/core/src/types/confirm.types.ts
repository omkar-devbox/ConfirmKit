...
> =
  | string
  | ((context: Readonly<C>) => any);


// ================================
// Behavior (Keyboard + Control)
// ================================
export interface ConfirmBehavior {
  ...
  /** Automatically focus an element on open. 'confirm', 'cancel', or a CSS selector. */
  initialFocus?: 'confirm' | 'cancel' | string;

  /** Restore focus to the previously focused element after closing. Default is true. */
...
// Responsive Override
// ================================
export interface ConfirmResponsive<
  T = any,
  C extends ConfirmContext = ConfirmContext
> {
